...
<body style="background:url(${pageContext.request.contextPath}/admin/images/topbg.gif) repeat-x;">
    <div class="topleft">
    <a href="main.html" target="_parent"><img src="${pageContext.request.contextPath}/admin/images/logo.png" title="系统首页" /></a>
    </div>
    <ul class="nav">
...
<%--     <li><a href="tab.html"  target="rightFrame"><img src="${pageContext.request.contextPath}/admin/images/icon06.png" title="系统设置" /><h2>系统设置</h2></a></li> --%>
    ...
    <li><a href="#">关于</a></li>
    <li><a href="${pageContext.request.contextPath}/cbdc/loginOut.json" target="_parent">退出</a></li>
    </ul>
    <div class="user">
