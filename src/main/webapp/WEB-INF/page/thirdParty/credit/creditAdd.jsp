...
<div class="place">
    ...
    <li><a href="#">信用卡平台录入</a></li>
    </ul>
    </div>
    <form action="${pageContext.servletContext.contextPath}/admin/credit/creditAdd.json" method="post" enctype="multipart/form-data">
	    <div class="formbody">
	    <div class="formtitle"><span>基本信息</span></div>
	    <ul class="forminfo">
	    <li><label>平台名称</label><input name="criditName" type="text" class="dfinput" /></li>
