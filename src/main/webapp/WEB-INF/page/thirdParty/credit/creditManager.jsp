...
window.location.href = "${pageContext.request.contextPath}/admin/credit/creditAddPage.json";
}
</script>
</head>
<body>
    ...
    <div class="tools">
    <ul class="seachform">
    <li><label>平台名称</label><input name="criditName" type="text" value="${creditModel.criditName}" class="scinput"></li>
    <li><label>&nbsp;</label><input name="" type="submit" class="scbtn" value="查询"></li>
    <li><label>&nbsp;</label><input name="" type="button" class="scbtn" value="平台添加" onclick="creditAdd()"></li>
    </ul>
    </div>
...
<!--     <th>是否活动</th> -->
    ...
    <tbody>
    <c:forEach var="creditModel" items="${creditList}">
	    <tr id="divtr">
		    <td class="imgtd"><img src="${creditModel.criditPicUrl}" height="50px" width="50px;"/></td>
		    <td><a href="#">${creditModel.criditName}</a>
		            <p>发布时间：
		                <fmt:formatDate value="${creditModel.createDate}" pattern="yyyy-MM-dd H:m:s"/>
		             </p>
		    </td>
		    <td>${creditModel.criditUrl}</td>
		    <td>${creditModel.criditSpecial}</td>
		    <td>${creditModel.totalApply}</td>
		   <td>
			    <center>
