...
<div class="place">
    ...
    <li><a href="#">信用卡平台修改</a></li>
    </ul>
    </div>
    <form action="${pageContext.servletContext.contextPath}/admin/credit/creditUpdate.json" method="post" enctype="multipart/form-data">
	    <div class="formbody">
	    <div class="formtitle"><span>基本信息</span></div>
	    <ul class="forminfo">
	    <li><label>平台名称</label>
	    <input  name="criditName" type="text" class="dfinput" value="${cridit.criditName}"/>
	    <input type="hidden" name="identifier" value="${cridit.identifier}"/>
	    </li>
	    <li><label>平台图标</label><input type="file"  name="file"/><img src="${cridit.criditPicUrl}" alt="" />
	    <input type="hidden" value="${cridit.criditPicUrl}" name="criditPicUrl"/>
	    </li>
	    <li><label>平台URL地址</label><input name="criditUrl" type="text"  class="dfinput" value="${cridit.criditUrl}"/></li>
	    <li><label>平台特点</label><input name="criditSpecial"  type="text" class="dfinput"   value="${cridit.criditSpecial}"/></li>
	     <li>
