...
<div class="place">
    ...
    <form  method="post">
	    ...
	    <ul class="forminfo">
	    <li><label>平台名称</label><input readonly="readonly" name="criditName" type="text" class="dfinput" value="${cridit.criditName}"/></li>
	    <li><label>平台图标</label><img src="${cridit.criditPicUrl}" alt="" /></li>
	    <li><label>平台URL地址</label><input name="criditUrl" type="text" readonly="readonly" class="dfinput" value="${cridit.criditUrl}"/></li>
	    <li><label>平台特点</label><input name="criditSpecial" readonly="readonly" type="text" class="dfinput"   value="${cridit.criditSpecial}"/></li>
