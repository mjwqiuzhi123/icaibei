...
<div class="place">
    ...
    <form  method="post">
	    ...
	    <ul class="forminfo">
	    <li><label>平台名称</label><input readonly="readonly" name="safeName" type="text" class="dfinput" value="${safe.safeName}"/></li>
	    <li><label>平台图标</label><img src="${safe.safePicUrl}" alt="" /></li>
	    <li><label>平台URL地址</label><input name="safeUrl" type="text" readonly="readonly" class="dfinput" value="${safe.safeUrl}"/></li>
	    <li><label>平台特点</label><input name="safeSpecial" readonly="readonly" type="text" class="dfinput"   value="${safe.safeSpecial}"/></li>
