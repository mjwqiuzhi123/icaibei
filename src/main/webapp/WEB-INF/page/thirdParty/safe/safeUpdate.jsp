...
<div class="place">
    ...
    <form action="${pageContext.servletContext.contextPath}/admin/safe/safeUpdate.json" method="post" enctype="multipart/form-data">
	    <div class="formbody">
	    <div class="formtitle"><span>基本信息</span></div>
	    <ul class="forminfo">
	    <li><label>平台名称</label>
	    <input  name="safeName" type="text" class="dfinput" value="${safe.safeName}"/>
	    <input type="hidden" name="identifier" value="${safe.identifier}"/>
	    </li>
	    <li><label>平台图标</label><input type="file"  name="file"/><img src="${safe.safePicUrl}" alt="" />
	     <input type="hidden" value="${safe.safePicUrl}" name="safePicUrl"/>
	    </li>
	    <li><label>平台URL地址</label><input name="safeUrl" type="text"  class="dfinput" value="${safe.safeUrl}"/></li>
	    <li><label>平台特点</label><input name="safeSpecial"  type="text" class="dfinput"   value="${safe.safeSpecial}"/></li>
	     <li>
